...
;(function (undefined) {
	...
	function Schedule (opt) {
		...
		var render = function () {
			var fullDay = new Date(year,month+1,0).getDate(), //褰撴湀鎬诲ぉ鏁�
				startWeek = new Date(year,month,1).getDay(), //褰撴湀绗竴澶╂槸鍛ㄥ嚑
				total = (fullDay+startWeek)%7 == 0 ? (fullDay+startWeek) : fullDay+startWeek+(7-(fullDay+startWeek)%7),//鍏冪礌鎬讳釜鏁�
				lastMonthDay = new Date(year,month,0).getDate(), //涓婃湀鏈€鍚庝竴澶�
				eleTemp = [];
